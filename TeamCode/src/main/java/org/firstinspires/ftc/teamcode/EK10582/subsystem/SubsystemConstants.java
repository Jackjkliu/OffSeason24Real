...
public class SubsystemConstants {
    ...
    public static int[] timingsForDump = {1000, 1600, 2200, 2900, 3500};
    public static int[] timingsForHangingSetup = {1000, 2000};
    public static int[] timingsForHighDump = {400, 1100, 1500};
